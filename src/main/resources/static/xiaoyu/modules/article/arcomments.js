...
var $coPromise = $
        .ajax({
            ...
            success : function(data) {
                ...
                var $html = '<div class="co_num"><span>全部评论</span><span>(' + obj.count + ')</span></div>';
                ...
                $
                        .each(
                                ...
                                function(index, co) {
                                    ...
                                    $html += '</div>';
                                    $html += '<div class="item_down"><label class="item_p_title_pure"><a id="' + co.replyerId + '">回复</a></label>';
                                    $html += '<label class="item_p_title_pure">' + co.createDate + '</label></div></div>';
